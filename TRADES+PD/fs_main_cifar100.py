...
from attack_methods_cifar100 import Attack_FeaScatter
...
if args.adv_mode.lower() == 'feature_scatter':
    ...
    net = Attack_FeaScatter(basic_net, config_pgd)
else:
    print('-----OTHER_ALGO mode -----')
    raise NotImplementedError("Please implement this algorithm first!")

attack_path = './models_new/checkpoint-199-ipot'
#net.load_state_dict({k.replace('module.', ''): v for k, v in torch.load(attack_path)['net'].items()})
